...
<div class="header-form-section">
  ...
  <section class="container  renew section" >
    <div class="row">
        ...
        <div class="col s12 l8 left form-main-div">
                ...
                <div class="col s12 l8 form-tab" id="payment_summ">
                    ...
                    <div class="row">
                        <div class="col s12 l12 flexed_spc_btn">                                    
                            ...
                            <div class="card-holder">
                                <input type="radio" id="test" name="card" value="test123"  onchange="setPaymentMethod(this)" required>
                                <label for="test">
                                    <img src="<?php echo base_url() . 'assets/images/credit-card-blk.svg'; ?> " alt="card-icon" class="card-icon">
                                    Test
                                </label>        
    ...
    $("#pay_next_btn").click(function() {
        if($('#paymentForm').validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('submit_renew_bdf');?>",
                    data: form_serialized,
                    dataType: "json",
                    success: function(data) {
                        if(data){
                            window.location.href = '<?php echo base_url('review_membership_dtls');?>'
                        }
                    },
