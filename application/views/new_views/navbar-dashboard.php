        ...
        <nav class="nav-wrapper-1 white z-depth-0"> 
            <div class="nav-container container-1">
                ...
                <ul class="hide-on-med-and-down right-nav-list">
                    ...
                    <li>
                        <a href="<?php echo base_url('dashboard_logout'); ?>" class="mdc-button mdc-button--outlined black-text z-depth-0" id="join_btn_black">
                            Logout
                        </a>
                    </li>                             
                </ul>
                ...
                <ul class="sidenav" id="mobile-menu">
                    ...
                    <li>
                         <a href="<?php echo base_url('dashboard_logout'); ?>" class="btn mdc-button mdc-button--outlined black-text z-depth-0" id="join_btn">
                            Logout
                        </a> 
                    </li>
                </ul>             
