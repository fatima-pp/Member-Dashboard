...
<body background-color="#f7f7f7" style="font-family:'Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; width: 100% !important; height: 100%; margin: 0; padding: 0;">

<!-- HEADER -->
<table class="head-wrap" background-color="#f7f7f7" style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; width: 100%; margin: 0; padding: 0;">
    ...
    <td class="header container" style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto; padding: 0;">
        ...
        <div class="content" style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; max-width: 600px; display: block; margin: 0 auto; padding: 0;">
        <table background-color="#f7f7f7" style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; width: 100%; margin: 0; padding: 0;">
            <tr style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; margin: 0; padding: 0;">
            <td style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; margin: 0; padding: 0;">
                <img src="http://18.130.138.242/valetparkpoint/src/Images/parkpointLogoEmail.png" style="width: 200px; display:flex;margin-left:auto;margin-right:auto;font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; max-width: 100%; padding: 0;" />
            </td>
            </tr>
        </table>
        </div>
...
<!-- BODY -->
<table class="body-wrap" background-color="white" style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; width: 100%; margin: 0; padding: 0;">
    <tr style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; margin: 0; padding: 0;">
    <td class="container" background-color="#FFFFFF" style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto; padding: 0;">
        ...
        <div class="content" style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; max-width: 600px; display: block; margin: 0 auto; padding: 15px;">
            <table style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; width: 100%; margin: 0; padding: 0;">
                <tr style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; margin: 0; padding: 0;">
                    <td style="font-family:' Helvetica Neue', Helvetica, Helvetica, Arial, sans-serif; margin: 0; padding: 0;color:#757575;">
                        <br/>
                        <p> Dear Member, </p> 
                        <p>	Greetings from ParkPoint! </p> 
                        <p>	Thank you for applying for ParkPoint membership at Bahrain Defence Force Royal Medical Services Hospital. </p> 
                        <p>	We hope you have a great experience ahead with our premier services at ParkPoint. </p> 
                        <p> Your Membership Details:  </p> <br>

                       <table>
                            <tr>
                                <th class="text-start-align">Name</th>
                                <td></td>
                                <td  class="text-end-align"><?= $first_name;?><?= $last_name;?></td>
                            </tr>
                            <tr>
                                <th class="text-start-align">Email</th>
                                <td></td>
                                <td class="text-end-align"><?= $email;?></td>
                            </tr>
                            <tr>
                                <th class="text-start-align">Mobile</th>
                                <td></td>
                                <td class="text-end-align"><?= $mobile_number;?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td class="text-end-align"><?=  date('t-M-Y', strtotime($expiry_date)); ?></td>
                            </tr>
                            <tr>
                       ...
                       <br>
                        ...
                        <p> Please visit ParkPoint  membership office to change your number plate. </p>
                        <p> For more information and inquiries, please contact us on +973- 38744448 or bdf.member@park-point.com. </p>
                        <p> Sincerely, </p>
                        <p> ParkPoint </p>
                        ...
                        <section class="arabic-section">
                            ...
                            <p>	.شكرًا لك على التقديم على عضوية بارك بوينت في الخدمات الطبية الملكية التابعة لقوة دفاع البحرين</p> 
                            <p>	.نأمل أن تحظى بتجربة رائعة مع خدماتنا الرائدة في بارك بوينت</p> 
                            <p> :تفاصيل العضوية  </p> <br>

                            <table style="display:flex !important;justify-content:flex-end !important;">
                                <tr>                                    
                                    <td  class="text-end-align-arabic"><?= $first_name;?><?= $last_name;?></td>
                                    <th class="text-start-align-arabic">الاسم</th>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td class="text-end-align-arabic"><?= $email;?></td>
                                    <th class="text-start-align-arabic">البريد الإلكتروني</th>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td class="text-end-align-arabic"><?= $mobile_number;?></td>
                                ...
                                <tr>
                                    <td class="text-end-align-arabic"><?=  date('t-M-Y', strtotime($expiry_date)); ?></td>
                                ...
                                <tr>
                                    <td class="text-end-align-arabic"><?= $id;?></td>
                            ...
                            <p> لمزيد من المعلومات والاستفسارات الرجاء التواصل  على
                            <span>٣٨٧٧٤٤٤٨</span>
                            <span>٩٧٣</span>
                            <span>+</span>
                            <span>او</span>
                            <span style="display:flex !important;justify-content:flex-end !important;"> bdf.member@park-point.com</span> </p>
